...
export default createLayoutPreset({
  ...
  title: {
    ...
    placement: { x: 0.90, y: 3.9, width: 12, height: 2, zIndex: 10 },
    style: {
   ...
   subtitle: {
    text: "Forever Missed",
    placement: { x: 0.90, y: 12.2, width: 12, height: 2, zIndex: 10 },
    style: {
      fontFamily: "Great Vibes",
      fontSize: 70,
      align: "center",
...
/* 
  ...
  optionalBlocks: [
    ...
    ------------------------------------------------------- */
     ...
     {
      type: "image",
      placement: { x: 1, y: 2.8, width: 4, height: 13.5, zIndex: 1 },
      config: {
     ...
     {
      type: "image",
      placement: { x: 8.8, y: 2.8, width: 4, height: 13.5, zIndex: 1 },
      config: {
 ...
 */
    ...
    {
      type: "label",
    placement: { x: 0.90, y: 13.3, width: 12, height: 2, zIndex: 10 },
      config: {
        label: "ILM Line",
