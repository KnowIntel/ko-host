      ...
      {site.template_key === "wedding_rsvp" ? (
        <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="mt-1 text-sm text-neutral-600">
                View RSVP responses submitted for this microsite.
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-xl border border-violet-300 bg-white px-4 py-2 text-sm font-medium text-violet-700 hover:border-violet-500"
              >
                View RSVP Responses
              </Link>
          ...
          <div className="mt-5 rounded-xl border border-neutral-200 bg-neutral-50 p-4">
            ...
            <div className="mt-2 text-sm text-neutral-600">
              Open the RSVP table to review guest responses, meal selections,
              guest counts, comments, and exported records.
            </div>
          </div>
        </div>
      ) : null}
