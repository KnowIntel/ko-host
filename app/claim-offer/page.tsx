...
const sampleCards = [
...

  {
    ...
    className:
      "right-[-50px] bottom-[340px] rotate-[8deg] hidden xl:block",
...

  {
    ...
    className:
      "right-[260px] bottom-[380px] rotate-[5deg] hidden xl:block",
...

  {
    ...
    className:
      "right-[280px] bottom-[260px] rotate-[7deg] hidden 2xl:block",
...

  {
    ...
    className:
      "left-[580px] bottom-[280px] rotate-[-4deg] hidden 2xl:block",
