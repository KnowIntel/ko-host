...
export function VideoInspector({
  ...
  const hasVideo = Boolean(String(selectedBlock.data.videoUrl ?? "").trim());
    ...
    <div className={inspectorCardClass()}>
      ...
      <div className="mt-4 rounded-xl border border-neutral-200 bg-neutral-50 p-3">
        ...
        <div className="mt-3">
          ...
          <select
            ...
            onChange={(e) => setVideoTextTarget(e.target.value as VideoTextTarget)}
      ...
      <div className="mt-4">
        ...
        {hasVideo ? (
          <button
            type="button"
            className="mt-3 w-full rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-sm font-semibold text-red-700 hover:bg-red-100"
            onClick={() =>
              updateSelectedBlock((block: any) =>
                block.type !== "video"
                  ? block
      ...
      <div className="mt-4 grid grid-cols-1 gap-3">
        ...
        <label className="flex items-center gap-3 rounded-xl border border-neutral-200 bg-neutral-50 px-3 py-3 text-sm">
          <input
            type="checkbox"
            checked={selectedBlock.data.showControls !== false}
            onChange={(e) =>
              updateSelectedBlock((block: any) =>
                block.type !== "video"
                  ? block
