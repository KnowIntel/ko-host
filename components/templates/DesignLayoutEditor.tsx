...
{ kind: "block", label: "Spreadsheet", type: "spreadsheet" },
  ...
  Icons: [
    ...
    { kind: "block", label: "Arrow Curve Down Left", type: "icon", iconName: "arrow-curve-down-left" },
    { kind: "block", label: "Arrow Curve Left Down", type: "icon", iconName: "arrow-curve-left-down" },
    { kind: "block", label: "Arrow Curve Left Up", type: "icon", iconName: "arrow-curve-left-up" },
    { kind: "block", label: "Arrow Curve Right Down", type: "icon", iconName: "arrow-curve-right-down" },
    { kind: "block", label: "Arrow Curve Right Up", type: "icon", iconName: "arrow-curve-right-up" },
    { kind: "block", label: "Arrow Curve Up Left", type: "icon", iconName: "arrow-curve-up-left" },
    { kind: "block", label: "Arrow Curve Up Right", type: "icon", iconName: "arrow-curve-up-right" },
    { kind: "block", label: "Arrow Left Right Broken", type: "icon", iconName: "arrow-left-right-broken" },
    { kind: "block", label: "Arrow Left Right", type: "icon", iconName: "arrow-left-right" },

    { kind: "block", label: "Arrow Thin Curve Down Left", type: "icon", iconName: "arrow-thin-curve-down-left" },
    { kind: "block", label: "Arrow Thin Curve Down Right", type: "icon", iconName: "arrow-thin-curve-down-right" },
    { kind: "block", label: "Arrow Thin Curve Left Down", type: "icon", iconName: "arrow-thin-curve-left-down" },
    { kind: "block", label: "Arrow Thin Curve Left Up", type: "icon", iconName: "arrow-thin-curve-left-up" },
    { kind: "block", label: "Arrow Thin Curve Right Down", type: "icon", iconName: "arrow-thin-curve-right-down" },
    { kind: "block", label: "Arrow Thin Curve Right Up", type: "icon", iconName: "arrow-thin-curve-right-up" },
    { kind: "block", label: "Arrow Thin Curve Up Left", type: "icon", iconName: "arrow-thin-curve-up-left" },
    { kind: "block", label: "Arrow Thin Curve Up Right", type: "icon", iconName: "arrow-thin-curve-up-right" },

    { kind: "block", label: "Arrow Up Left", type: "icon", iconName: "arrow-up-left" },
    { kind: "block", label: "Arrow Up Right", type: "icon", iconName: "arrow-up-right" },
    { kind: "block", label: "Target Bullseye", type: "icon", iconName: "target-bullseye" },
    ...
    { kind: "block", label: "Autumn Leaf", type: "icon", iconName: "autumn-leaf" },
    { kind: "block", label: "Clover Leaf", type: "icon", iconName: "clover-leaf" },
    { kind: "block", label: "Flowers Garden", type: "icon", iconName: "flowers-garden" },
    { kind: "block", label: "Leaf", type: "icon", iconName: "leaf" },
    { kind: "block", label: "Settings Cycle", type: "icon", iconName: "settings-cycle" },
    ...
    { kind: "block", label: "WhatsApp Social Media", type: "icon", iconName: "whatsapp-social-media" },
    { kind: "block", label: "YouTube Social Media", type: "icon", iconName: "youtube-social-media" },
    { kind: "block", label: "Instagram Social Media", type: "icon", iconName: "instagram-social-media" },
    { kind: "block", label: "Facebook Social Media", type: "icon", iconName: "facebook-social-media" },
    { kind: "block", label: "Umbrella", type: "icon", iconName: "umbrella" },
    { kind: "block", label: "Passport Ticket", type: "icon", iconName: "passport-ticket" },
    { kind: "block", label: "Money Bank Note", type: "icon", iconName: "money-bank-note" },
    { kind: "block", label: "Money Finance Coins", type: "icon", iconName: "money-finance-coins" },
    { kind: "block", label: "Global Money", type: "icon", iconName: "global-money" },
    { kind: "block", label: "Bed Lodging", type: "icon", iconName: "bed-lodging" },
    ...
    { kind: "block", label: "Alien Head", type: "icon", iconName: "alien-head" },
    { kind: "block", label: "Hands Home Safe Space", type: "icon", iconName: "hands-home-safe-space" },
    { kind: "block", label: "Loan Contract", type: "icon", iconName: "loan-contract" },
    { kind: "block", label: "Broken Heart", type: "icon", iconName: "broken-heart" },
    { kind: "block", label: "Circumstances Concerns Decisions", type: "icon", iconName: "circumstances-concerns-decisions" },
    { kind: "block", label: "Conflict Domestic", type: "icon", iconName: "conflict-domestic" },
    { kind: "block", label: "Conflict Peer", type: "icon", iconName: "conflict-peer" },
    { kind: "block", label: "Couple Together Relationship", type: "icon", iconName: "couple-together-relationship" },
    { kind: "block", label: "Family Group", type: "icon", iconName: "family-group" },
    { kind: "block", label: "Flower Rose", type: "icon", iconName: "flower-rose-" },
    { kind: "block", label: "Locker Safe", type: "icon", iconName: "locker-safe" },
    { kind: "block", label: "Meeting People", type: "icon", iconName: "meeting-people" },
    { kind: "block", label: "Planet Space", type: "icon", iconName: "planet-space" },
    { kind: "block", label: "Real Estate Closed Hands", type: "icon", iconName: "real-estate-closed-hands" },
    { kind: "block", label: "Safe Space", type: "icon", iconName: "safe-space" },
    ...
    { kind: "block", label: "Bell Outline", type: "icon", iconName: "bell-outline" },
    { kind: "block", label: "Bell Silent Outline", type: "icon", iconName: "bell-silent-outline" },
    { kind: "block", label: "Bell Silent Solid", type: "icon", iconName: "bell-silent-solid" },
    { kind: "block", label: "Bell Solid", type: "icon", iconName: "bell-solid" },
    { kind: "block", label: "Cloudy Sky Sun", type: "icon", iconName: "cloudy-sky-sun" },
    { kind: "block", label: "Moon Stars", type: "icon", iconName: "moon-stars" },
    { kind: "block", label: "Pill Tablet Med", type: "icon", iconName: "pill-tablet-med" },
    { kind: "block", label: "Rain Drop", type: "icon", iconName: "rain-drop" },
    { kind: "block", label: "Soup Cup Food", type: "icon", iconName: "soup-cup-food" },
    { kind: "block", label: "Sun Shine Ray", type: "icon", iconName: "sun-shine-ray" },
    { kind: "block", label: "Thunder Lightning Storm", type: "icon", iconName: "thunder-lightning-storm" },
    ...
    { kind: "block", label: "User Male Remove Invalid", type: "icon", iconName: "user-male-remove-invalid" },
    { kind: "block", label: "User Male Approved Valid", type: "icon", iconName: "user-male-approved-valid" },
    { kind: "block", label: "User Female Remove Invalid", type: "icon", iconName: "user-female-remove-invalid" },
    { kind: "block", label: "User Female Approved Valid", type: "icon", iconName: "user-female-approved-valid" },
    { kind: "block", label: "Crown King Queen Royalty", type: "icon", iconName: "crown-king-queen-royalty" },
    { kind: "block", label: "Lock Secure Check", type: "icon", iconName: "lock-secure-check" },
    { kind: "block", label: "Skull Bones Hazardous", type: "icon", iconName: "skull-bones-hazardous" },
    { kind: "block", label: "Anonymous User Undercover Question", type: "icon", iconName: "anonymous-user-undercover-question" },
    { kind: "block", label: "Number Pad Solid", type: "icon", iconName: "number-pad-solid" },
    { kind: "block", label: "Number Pad Outline", type: "icon", iconName: "number-pad-outline" },
    { kind: "block", label: "Cell Phone Charge", type: "icon", iconName: "cell-phone-charge" },
    { kind: "block", label: "Plug", type: "icon", iconName: "plug" },
    { kind: "block", label: "RSVP Envelope", type: "icon", iconName: "rsvp-envelope" },
    { kind: "block", label: "Luggage Suitcase Solid", type: "icon", iconName: "luggage-suitcase-solid" },
    { kind: "block", label: "Luggage Suitcase Outline", type: "icon", iconName: "luggage-suitcase-outline" },
    { kind: "block", label: "Briefcase Bag", type: "icon", iconName: "briefcase-bag" },
    ...
    { kind: "block", label: "Bedtime Night", type: "icon", iconName: "bedtime-night" },
    { kind: "block", label: "Dinner Food Meal", type: "icon", iconName: "dinner-food-meal" },
    { kind: "block", label: "Food Drink Lunch", type: "icon", iconName: "food-drink-lunch" },
    { kind: "block", label: "Lotion Cream Care", type: "icon", iconName: "lotion-cream-care" },
    { kind: "block", label: "Heartbeat Alive", type: "icon", iconName: "heartbeat-alive" },
    { kind: "block", label: "Peanuts Snack", type: "icon", iconName: "peanuts-snack" },
    { kind: "block", label: "Walk Exercise Activity", type: "icon", iconName: "walk-exercise-activity" },
    ...
    { kind: "block", label: "Letter Bubble A", type: "icon", iconName: "letter-bubble-A" },
    { kind: "block", label: "Letter Bubble B", type: "icon", iconName: "letter-bubble-B" },
    { kind: "block", label: "Letter Bubble C", type: "icon", iconName: "letter-bubble-C" },
    { kind: "block", label: "Letter Bubble D", type: "icon", iconName: "letter-bubble-D" },
    { kind: "block", label: "Letter Bubble E", type: "icon", iconName: "letter-bubble-E" },
    { kind: "block", label: "Letter Bubble F", type: "icon", iconName: "letter-bubble-F" },
    { kind: "block", label: "Letter Bubble G", type: "icon", iconName: "letter-bubble-G" },
    { kind: "block", label: "Letter Bubble H", type: "icon", iconName: "letter-bubble-H" },
    { kind: "block", label: "Letter Bubble I", type: "icon", iconName: "letter-bubble-I" },
    { kind: "block", label: "Letter Bubble J", type: "icon", iconName: "letter-bubble-J" },
    { kind: "block", label: "Letter Bubble K", type: "icon", iconName: "letter-bubble-K" },
    { kind: "block", label: "Letter Bubble L", type: "icon", iconName: "letter-bubble-L" },
    { kind: "block", label: "Letter Bubble M", type: "icon", iconName: "letter-bubble-M" },
    { kind: "block", label: "Letter Bubble N", type: "icon", iconName: "letter-bubble-N" },
    { kind: "block", label: "Letter Bubble O", type: "icon", iconName: "letter-bubble-O" },
    { kind: "block", label: "Letter Bubble P", type: "icon", iconName: "letter-bubble-P" },
    { kind: "block", label: "Letter Bubble Q", type: "icon", iconName: "letter-bubble-Q" },
    { kind: "block", label: "Letter Bubble R", type: "icon", iconName: "letter-bubble-R" },
    { kind: "block", label: "Letter Bubble S", type: "icon", iconName: "letter-bubble-S" },
    { kind: "block", label: "Letter Bubble T", type: "icon", iconName: "letter-bubble-T" },
    { kind: "block", label: "Letter Bubble U", type: "icon", iconName: "letter-bubble-U" },
    { kind: "block", label: "Letter Bubble V", type: "icon", iconName: "letter-bubble-V" },
    { kind: "block", label: "Letter Bubble W", type: "icon", iconName: "letter-bubble-W" },
    { kind: "block", label: "Letter Bubble X", type: "icon", iconName: "letter-bubble-X" },
    { kind: "block", label: "Letter Bubble Y", type: "icon", iconName: "letter-bubble-Y" },
    { kind: "block", label: "Letter Bubble Z", type: "icon", iconName: "letter-bubble-Z" },
    { kind: "block", label: "Speech Comment Bubble", type: "icon", iconName: "speech-comment-bubble" },
    { kind: "block", label: "Thought Bubble Outline", type: "icon", iconName: "thought-bubble-outline" },
    { kind: "block", label: "Thought Bubble Solid", type: "icon", iconName: "thought-bubble-solid" },
...
<div className="sticky top-0 z-[100] w-full bg-[#2f3541] shadow-md">
  <div className="flex w-full items-center bg-[#2f3541] px-2 py-2">
    ...
    <div
      ref={topBarScrollRef}
      className="top-toolbar-scrollbar min-w-0 flex-1 overflow-x-auto overflow-y-hidden pb-2"
    >
      <div className="flex min-w-max items-end gap-2 pt-2 pb-0 min-h-[56px]">
