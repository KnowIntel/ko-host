...
export default createLayoutPreset({
  ...
  title: {
    ...
    placement: { x: 1.15, y: 2.8, width: 12, height: 2, zIndex: 15 },
    style: {
      fontFamily: "Inter",
      fontSize: 100,
      align: "center",
  ...
  subtitle: {
    ...
    placement: { x: 3, y: 4.1, width: 8, height: 1, zIndex: 11 },
    style: {
      fontFamily: "Arial",
      bold: true,
      fontSize: 40,
    ...
    placement: { x: 1, y: 5.06, width: 12, height: 3, zIndex: 13 },
    style: {
      fontFamily: "Arial",
      bold: true,
      fontSize: 50,
  ...
  optionalBlocks: [
   ...
   {
      type: "shape",
      placement: { x: 4.7, y: 4.7, width: 4.5, height: 1.6, zIndex: 2 },
      config: {
        shapeType: "circle",
        borderColor: "#FFFFFF",
        borderWidth: 30,
