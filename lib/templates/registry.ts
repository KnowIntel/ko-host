...
const RAW_TEMPLATE_DEFS: TemplateInput[] = [
  ...
  },
  {
    ...
    title: "Marketing Campaign Landing",
    description: "Campaign message, CTA, and links.",
    thumb: "marketingcampaignlandingpage",
    setupMins: 3,
    demoSlug: "marketing",
  ...
  },
  {
    ...
    thumb: "newstoreopeningannouncement",
    setupMins: 2,
    demoSlug: "opening",
  ...
  },
  {
    key: "book_launch",
    title: "Book Launch",
    description: "Book info, links, and launch updates.",
    thumb: "booklaunchpage",
    setupMins: 3,
    demoSlug: "book",
    defaultDraft: { title: "Book Launch", slugSuggestion: "booklaunch" },
  },
  {
    key: "newsletter_signup",
    title: "Newsletter Signup",
    description: "Collect subscribers and share benefits.",
    thumb: "newslettersignuppage",
    setupMins: 2,
    demoSlug: "newsletter",
